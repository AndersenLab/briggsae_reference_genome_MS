...
## AF16 amino acids 
table <- read.table("QX1410_vs_AF16.distance_by_position.mafft.tsv", col.names = c("gene", "id", "chr", "start"))
...
## VX34 amino acids 
table <- read.table("QX1410_vs_VX34.distance_by_position.mafft.tsv", col.names = c("gene", "id", "chr", "start"))
